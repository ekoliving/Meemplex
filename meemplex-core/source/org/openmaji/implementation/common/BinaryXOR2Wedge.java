...
/**
 * <p>
 * The BinaryXOR2Wedge is used to "logically XOR" the values of exactly two
...
public class BinaryXOR2Wedge extends BinaryInput2Base implements Wedge {
  ...
  public static final WedgeDefinition WEDGE_DEFINITION =
    BinaryInput2Base.getWedgeDefinition(
      "org.openmaji.implementation.common.BinaryXOR2Wedge"
    );

  /**
   * Perform the logical XOR operation on the two inputs.
   *
   * @param input1 boolean input 1
   * @param input2 boolean input 2
   * @return boolean result of the logical XOR operation
   */
