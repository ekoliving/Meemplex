...
import org.openmaji.implementation.common.LinearListWedge;
...
public class LoopbackLinearListMeem implements MeemDefinitionProvider
{
  ...
  public MeemDefinition getMeemDefinition()
  {
    if ( meemDefinition == null )
    {
      ...
      wedges[0] = LinearListWedge.class;
      wedges[1] = LoopbackLinearListWedge.class;
      meemDefinition = MeemDefinitionFactory.spi.create().createMeemDefinition(wedges);
      meemDefinition.getMeemAttribute().setIdentifier("LoopbackLinearList");
