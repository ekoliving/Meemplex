...
public class LoopbackFalseBinaryMeem implements MeemDefinitionProvider
{
  ...
  public MeemDefinition getMeemDefinition()
  {
    if ( meemDefinition == null )
    {
      ...
      wedges[1] = LoopbackFalseBinaryWedge.class;
      meemDefinition = MeemDefinitionFactory.spi.create().createMeemDefinition(wedges);
      meemDefinition.getMeemAttribute().setIdentifier("LoopbackFalseBinary");
