...
public class RetargetAction extends PartEventAction {
	 ...
	 * Constructs a RetargetAction.
	 */
	public RetargetAction(String actionID, int style) {
		this(actionID, "", style);
	}
	 ...
	 * Constructs a RetargetAction.
	 */
	public RetargetAction(String actionID, String label, int style) {
		super(label, style);
		setId(actionID);
		setEnabled(false);
		super.setHelpListener(new HelpListener() {
	...
	public void partActivated(IWorkbenchPart part) {
		...
		actionRegistry = (ActionRegistry)part.getAdapter(ActionRegistry.class);
	}
	...
	public IMenuCreator getMenuCreator() {
		if(getActionHandler() == null) return super.getMenuCreator();
