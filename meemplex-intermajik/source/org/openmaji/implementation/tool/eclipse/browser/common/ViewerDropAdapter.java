...
package org.openmaji.implementation.tool.eclipse.browser.common;
...
/**
 * <code>ViewerDropAdapter</code>.
 * <p>
 * @author Kin Wong
 */
abstract public class ViewerDropAdapter extends DropTargetAdapter {
	/**
...
private void doDropValidation(DropTargetEvent event) {
	...
	if (validateDrop(currentTarget, event.detail, event.currentDataType, event.data)) {
...
public void drop(DropTargetEvent event) {
	try {
		...
		if (!performDrop(event.currentDataType, event.data)) {
 ...
 */
public abstract boolean performDrop(TransferData transferType, Object data);
/* (non-Javadoc)
 * Method declared on DropTargetAdapter.
 * The mouse has moved over the drop target.  If the
 * target item has changed, notify the action and check
 ...
 *   otherwise
 */
public abstract boolean validateDrop(Object target, int operation, TransferData transferType, Object data);
}
