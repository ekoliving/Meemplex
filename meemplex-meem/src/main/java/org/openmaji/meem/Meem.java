 ...
 *   Warren, Christos, MG, Diana, Kin and Ben for their dedication. *
 \------------------------------------------------------------------*/
	 ...
	 */
	public <F extends Facet> void addOutboundReference(Reference<F> reference, boolean automaticRemove);
	 ...
	 */
	public <F extends Facet> void removeOutboundReference(Reference<F> reference);
