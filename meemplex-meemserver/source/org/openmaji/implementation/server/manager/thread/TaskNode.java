...
public class TaskNode implements Runnable {
	...
	TaskNode(Subject subject, Runnable task) {
		if (subject == null) {
			throw new IllegalArgumentException("Attempt to create task with no Subject");
		}
	...
	private class PrivilegedRunnable implements PrivilegedAction<Void> {
		private Runnable task;
