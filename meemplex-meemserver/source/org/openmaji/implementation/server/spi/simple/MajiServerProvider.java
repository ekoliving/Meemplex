...
/**
 * <p>
 * This is a scaled-down version of the MajiServerProvider for doing things like
 * constructing MeemPaths outside of a full-blown Maji Server.
 * </p>
 * <p>
...
public class MajiServerProvider extends MajiSystemProvider {
	...
	public <T> T create(Class<T> specification, Object[] args) {
		...
		try {
			...
			throw new IllegalArgumentException("Couldn't instantiate " + specification + ": " + exception);
		}
