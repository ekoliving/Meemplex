...
//		}
  ...
  public static MeemkitHeader createMeemkitHeader(String filename) {
	  // TODO use JAXB for unmarshalling the meemkit descriptior file.
//	  try {
//		  JAXBContext context = JAXBContext.newInstance("org.meemplex.server.model.meemkit");
//		  Meemkit meemkit = (Meemkit) context.createUnmarshaller().unmarshal(new File(filename));
//		  meemkit.name;
//	  }
