...
public class MeemkitManagerWedge implements Wedge, MeemkitManager, Meemkit, JiniLookupClient, CategoryClient, LifeCycleManagerClient {
	...
	public void conclude() {
		...
		if (categoryMeem != null) {
			MeemClientCallback<LifeCycle> callback = new MyCallback();
	...
	private class MyCallback implements MeemClientCallback<LifeCycle> {
		public void referenceProvided(Reference<LifeCycle> reference) {
			if (reference != null) {
				LifeCycle lifeCycle = reference.getTarget();
