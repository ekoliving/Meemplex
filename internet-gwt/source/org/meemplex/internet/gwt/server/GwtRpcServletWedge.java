...
public class GwtRpcServletWedge implements Wedge {
	...
	public void commence() {
		String classname = MeemGwtServlet.class.getName();		
		Properties properties = new Properties();
		properties.setProperty(MeemGwtServlet.PROPERTY_SESSION_TIMEOUT, Long.toString(sessionTimeout*1000));
